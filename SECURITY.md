...
- The `AD-SecretGen` version (`ad-secretgen --version`) and your environment.
...
`AD-SecretGen` is security-research tooling intended for authorized testing only. Running it against systems or data you do not own or lack explicit written permission to assess may be illegal. Reports demonstrating misuse against third-party systems are out of scope.
